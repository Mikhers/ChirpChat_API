...
from .views_custom import AuthViewSet, ListaAmigosViewSet, ListaChatViewSet, ListasolicitudViewSet, ListapublicacionesViewSet
...
urlpatterns += [
    ...
    path('lista-publicaciones/<str:id>/', ListapublicacionesViewSet.as_view(), name='lista-de-publicaciones'),
